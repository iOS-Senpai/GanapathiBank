...
final class AppContainer {
    ...
    lazy var apiClient: APIClient = URLSessionAPIClient(configuaration: configuaration)

    lazy var accountsRemoteDataSource = APIAccountsRemoteDataSource(apiClient: apiClient)
    ...
    lazy var accountsLocalDataSource = SwiftDataAccountsLocalDataSource(context: modelContext)

    lazy var accountsRepository: AccountsRepository = MockAccountsRepository() // DefaultAccountsRepository(remote: accountsRemoteDataSource, local: accountsLocalDataSource)
